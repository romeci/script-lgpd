...
const texto_lgpd =
  "<strong>Nome da Empresa:</strong> nós utilizamos cookies para melhorar a sua experiência no site. Ao continuar navegando, você concorda com a nossa ";
...
function openLgpd() {
  ...
  window.onload = function () {
    ...
    document.querySelector(destino_html_lgpd).innerHTML +=
      "<lgpd><div><p>" +
      texto_lgpd +
      "<a href='#!'>Politica de Privacidade</a></p></div><button>" +
      text_btn +
      "</button></lgpd>";
